...
namespace ActionView\View\Test;
...
class ConcreteViewTest extends \PHPUnit_Framework_TestCase
{
  ...
  {
    $view_factory = new \ActionView\Factory\ViewFactory;
  ...
  {
    $this->assertInstanceOf('ActionView\Registry\TemplateRegistry', $this->view->getViewRegistry());
    $this->assertInstanceOf('ActionView\Registry\TemplateRegistry', $this->view->getLayoutRegistry());
  }
  ...
  public function testViewVariableRendering()
  {
    $view = new \ActionView\View\Concrete(
      new \ActionView\Registry\TemplateRegistry(array(
  ...
  {
    $view = new \ActionView\View\Concrete(
      new \ActionView\Registry\TemplateRegistry(array('foo' => __DIR__ . '/templates/foo_template.php')),
      new \ActionView\Registry\TemplateRegistry
    );
